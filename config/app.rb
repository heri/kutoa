...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'kutoa.com'
  config.app_name = 'Kutoa'
  config.mailer.from = 'Kutoa <no-reply@kutoa.com>'
  ...
  #
  config.app_secret = '-ROK6YPUDwSUc4HzJnIgLyoKeHvTlWz0Fo69UjZ6fJt0cafaoz8jdN5TbqiwkCGnjQw'
